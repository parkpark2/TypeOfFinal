...
<!-- Navigation Bar --> 
 ...
 <a href="<%=request.getContextPath()%>/index.go">
  <img src="<%= request.getContextPath() %>/resources/images/oneofall/logo.png" style="width:200px; height:60px; margin-left: 30px;"/>
               ...
               <input type="text" id="search" name="search" placeholder="検索" size="10" style="height: 30px;" />&nbsp; 
               ...
               <input type="text" class="datepicker" name="startDate" placeholder="チェックイン" size="10" style="height: 30px;" />&nbsp; 
               
               <label><i class="fa fa-calendar-o"></i></label>&nbsp;              
               <input type="text" class="datepicker" name="endDate"  placeholder="チェックアウト" size="10" style="height: 30px;" />&nbsp; 
