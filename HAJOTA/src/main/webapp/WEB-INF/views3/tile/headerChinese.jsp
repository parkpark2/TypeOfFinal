...
<!-- Navigation Bar --> 
 <div class="w3-bar w3-white w3-border-bottom w3-xlarge">
  <img src="<%= request.getContextPath() %>/resources/images/oneofall/logo.png" style="width:200px; height:60px; margin-left: 30px;"/>
               ...
               <input type="text" class="datepicker" name="startDate" placeholder="入住" size="10" style="height: 30px;" />&nbsp; 
               
               <label><i class="fa fa-calendar-o"></i></label>&nbsp;              
               <input type="text" class="datepicker" name="endDate"  placeholder="退房" size="10" style="height: 30px;" />&nbsp; 
