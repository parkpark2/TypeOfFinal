...
<div id="content" style="border: solid 0px red; margin-left: 25px;">
   <div style="margin-top:2%; margin-left:0%;" id="content"> 
      <img src="<%= request.getContextPath() %>/resources/images/HSSH/manager.png" style="width: 4%; height: 4%; margin-left: 3%"/>    
      <span style="font-weight:bold; font-size:20pt;">&nbsp;&nbsp;Manager</span><br/><br/>
      <span style="font-weight:bold; font-size:18pt; color:blue; margin-left:9%; margin-top:-1%;">경리 서영학</span>  
   </div>  
